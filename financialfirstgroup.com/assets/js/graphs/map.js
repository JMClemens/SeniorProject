      ...
      d3.csv("../assets/data/acf.csv", function(error3, winData) {
			...
			*/
			...
			var aTotalAttacks = d3.sum(winData, function(d) {
				 return d.Frequency;
				 console.log(aTotalAttacks)
			});			
			
			var gPercnt = parseFloat(((gTotalAttacks / (gTotalAttacks+aTotalAttacks))*100).toFixed(2));
			var aPercnt = parseFloat(((aTotalAttacks / (gTotalAttacks+aTotalAttacks))*100).toFixed(2));
